-- Suppresion de la BD si elle existe
-- Permet de réexécuté le script en partant d'une base vierge
...
INSERT INTO tasks (title, due_date, completion_rate, category_id)
    VALUES ('acheter du lait', '2020-4-11', 0, 1),
...
CREATE OR REPLACE VIEW view_tasks AS
    ...
    FROM tasks
        ...
        INNER JOIN task_status ON task_status.id = tasks.status_id